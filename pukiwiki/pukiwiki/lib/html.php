...
function edit_form($page, $postdata, $digest = FALSE, $b_template = TRUE)
{
	...
	global $whatsnew, $_btn_template, $_btn_load, $load_template_func, $load_template_list;
	global $notimeupdate;
	...
	if($load_template_func && $b_template) {
		$pages  = array();
    foreach($load_template_list as $_page) {
      $s_page = htmlsc($_page);
...
$template
  ...
  <textarea name="msg" class="form-control" rows="$rows" cols="$cols">$s_postdata</textarea>
  <br />
  <input type="submit" name="preview" class="btn btn-default" value="$btn_preview" accesskey="p" />
  <input type="submit" name="write"   class="btn btn-primary" value="$_btn_update" accesskey="s" />
	<div class="form-group">
  $add_top
  $add_notimestamp
	</div>
  <input type="submit" name="cancel" class="btn btn-default" value="$_btn_cancel" accesskey="c" />
