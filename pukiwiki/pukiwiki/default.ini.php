...
define('SKIN_FILE', DATA_HOME . SKIN_DIR . 'wolfbbs.skin.php');

/////////////////////////////////////////////////
// 雛形とするページの読み込みを可能にする
$load_template_func = 1;
$load_template_pattern = "/Template$/";
$load_template_list = array("PlayerTemplate", "VillageTemplate", "おすすめログ/Template", "作戦Template");
