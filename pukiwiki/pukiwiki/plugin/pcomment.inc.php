...
// Auto log rotation
define('PLUGIN_PCOMMENT_AUTO_LOG', 30); // 0:off 1-N:number of comments per page

// Update recording page's timestamp instead of parent's page itself
define('PLUGIN_PCOMMENT_TIMESTAMP', 1);
...
function plugin_pcomment_convert()
{
  ...
  // http://pukiwiki.sourceforge.jp/dev/?BugTrack2%2F182
...
EOD;
  ...
  if ($GLOBALS["ad_flag"] <= 3) {
    $GLOBALS["ad_flag"] += 1;
    $ad = <<<EOD
    <div style="margin: 1em 4em">
    <script type="text/javascript"><!--
    google_ad_client = "pub-7969419198588736";
    google_alternate_ad_url = "http://wolfbbs.jp/google_adsense_script.htm";
    google_ad_width = 468;
    google_ad_height = 60;
    google_ad_format = "468x60_as";
    google_ad_type = "text_image";
    google_ad_channel ="1594671533";
    google_color_border = "FFFFFF";
    google_color_bg = "FFFFFF";
    google_color_link = "004626";
...
EOD;
    ...
    $recent = convert_html("#ls2(" . strip_bracket($page) . ")");
	}
