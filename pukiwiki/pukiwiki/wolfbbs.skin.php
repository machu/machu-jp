...
<?php } ?>
 ...
 <link rel="stylesheet" href="/skin/wolfbbs.css" type="text/css" media="screen" />
...
<div class="container-fluid">
  ...
  <div class="navbar-header">
    ...
    <a class="navbar-brand" href="#">人狼BBSまとめサイト</a>
  </div>
  ...
  <div class="collapse navbar-collapse" id="navbar-collapse-1">
    <ul class="nav navbar-nav">
      <?php if($is_page) { ?>
        <?php  if($is_read) { ?>
          <li><a href="<?php echo $link_edit ?>" rel="nofollow"><img src="http://wolfbbs.jp/image/edit.png" width="20" height="20" alt="Edit" title="このページを編集する" />このページを編集する</a></li>
          <li><a href="<?php echo $link_diff ?>" rel="nofollow"><img src="http://wolfbbs.jp/image/diff.png" width="20" height="20" alt="Diff" title="編集された箇所をみる" />編集された箇所をみる</a></li>
        <?php } ?>
        <li><a href="<?php echo $link_backup ?>" rel="nofollow"><img src="http://wolfbbs.jp/image/backup.png" width="20" height="20" alf="Backup" title="このページのバックアップ" />このページのバックアップ</a></li>
      <?php } ?>
    </ul>
